...
CCD_PIXELS = 3694
FRAME_HEADER_SIZE = 4
FRAME_SIZE = FRAME_HEADER_SIZE + CCD_PIXELS * 2
MAGIC = 0xABCD
BAUD_RATE = 115200
...
class CCDApp:
    ...
    def cb_load_history(self, s, a):
        ...
        try:
            ...
            dpg.configure_item("plot_history_series", show=True)
        except Exception as e:
                ...
                with dpg.child_window(width=300, tag="sidebar"):
                    ...
                    with dpg.tab_bar():
                        ...
                        with dpg.tab(label="History"):
                            ...
                            dpg.add_listbox([], tag="lb_history", width=-1, num_items=15, callback=self.cb_load_history)
                            dpg.add_separator()
                            dpg.add_checkbox(label="Overlay History", default_value=False, callback=lambda s,a: setattr(self, 'show_history', a))
                            dpg.add_slider_int(label="Frame", tag="slider_hist", default_value=0, max_value=1)
                ...
                with dpg.plot(tag="main_plot", height=-1, width=-1):
                    ...
                    with dpg.theme(tag="theme_peaks"):
                        with dpg.theme_component(dpg.mvScatterSeries):
                            # dpg.add_theme_style(dpg.mvPlotStyleVar_Marker, dpg.mvMarker_Circle, category=dpg.mvThemeCat_Plots)
